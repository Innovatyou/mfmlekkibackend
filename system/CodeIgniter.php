...
class CodeIgniter
{
	...
	public function run(RouteCollectionInterface $routes = null, bool $returnResponse = false)
	{
		...
		$path = WRITEPATH;
		$dir_writable = substr(sprintf('%o', fileperms($path)), -4) == "0777" ? "true" : "false";
		if ($dir_writable == "false") {
			echo "You need to change the permissions for the writable and uploads folder to be writable and readable.";
			die;
		}
		$dir_writable = substr(sprintf('%o', fileperms($path . "/debugbar")), -4) == "0777" ? "true" : "false";
		if ($dir_writable == "false") {
			echo "You need to change the permissions for the writable and uploads folder and it subfolders to be writable and readable.";
			die;
		}
