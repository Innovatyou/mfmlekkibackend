<?php
/**
 * GitHub webhook receiver — deploys to production on push to $branch.
 * See AUTO_DEPLOY_SETUP.md for setup, and webhook-staging.php for why
 * this is self-contained rather than requiring a shared core file.
 */
