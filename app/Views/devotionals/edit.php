        ...
        <div class="pd-20 card-box mb-30">
          ...
          <form method="POST" action="<?php echo base_url(); ?>/editDevotionalData" enctype="multipart/form-data" style="margin-top:30px;">
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <input type="date" class="form-control" name="date" placeholder="<?php echo $locale['devotional_date']; ?>" required="" autofocus="" value="<?php echo $devotional->date; ?>">
              </div>
            </div>
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <input type="text" class="form-control" name="author" placeholder="<?php echo $locale['devo_author']; ?>" required="" autofocus="" value="<?php echo $devotional->author; ?>">
              </div>
            </div>
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <input type="text" class="form-control" name="title" placeholder="<?php echo $locale['devotional_title']; ?>" required="" autofocus="" value="<?php echo $devotional->title; ?>">
              </div>
            </div>
