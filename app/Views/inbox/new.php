        ...
        <div class="pd-20 card-box mb-30">
          ...
          <form method="POST" action="<?php echo base_url(); ?>/sendnewinbox" enctype="multipart/form-data" style="margin-top:30px;">
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <input type="text" class="form-control" name="title" placeholder="<?php echo $locale['title']; ?>" required="" autofocus="">
              </div>
            </div>
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <textarea type="text" class="form-control" name="message" placeholder="<?php echo $locale['inbox_content']; ?>" required="" autofocus="" required></textarea>
              </div>
            </div>
