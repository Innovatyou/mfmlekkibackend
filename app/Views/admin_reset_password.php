...
<head>
	<meta charset="utf-8">
	<title>MyChurchApp — Reset Password</title>
...
<body>
		...
		<div class="login-card">
			...
			<div class="form-panel">
				...
				<form action="<?= base_url('admin-change-password') ?>" method="POST">
					...
					<input type="hidden" name="activation_id" value="<?= esc($activation_id) ?>">
					...
					<div class="field-group">
						...
						<button type="button" class="field-icon" id="togglePwd1" tabindex="-1">
							<svg id="eye1Show" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
								<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
								<circle cx="12" cy="12" r="3"></circle>
							</svg>
							<svg id="eye1Hide" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:none">
					...
					<div class="field-group">
						...
						<button type="button" class="field-icon" id="togglePwd2" tabindex="-1">
							<svg id="eye2Show" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
								<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
								<circle cx="12" cy="12" r="3"></circle>
							</svg>
							<svg id="eye2Hide" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display:none">
								<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
								<line x1="1" y1="1" x2="23" y2="23"></line>
							</svg>
						</button>
	...
	<script>
		function toggleField(btnId, inputId, showId, hideId) {
		...
		toggleField('togglePwd1', 'password1', 'eye1Show', 'eye1Hide');
		toggleField('togglePwd2', 'password2', 'eye2Show', 'eye2Hide');
	</script>
</body>
