          ...
          <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo $locale['add_member_group']; ?></li>
              </ol>
            </nav>
          </div>
        ...
        <div class="pd-20 card-box mb-30">
          ...
          <form method="POST" action="<?php echo base_url(); ?>/savenewmembersgroup" enctype="multipart/form-data" style="margin-top:30px;">
            ...
            <div class="box-footer text-center" style="margin-top:50px;">
              <button class="btn btn-primary waves-effect" type="submit"><?php echo $locale['add_to_group']; ?></button>
            </div>
