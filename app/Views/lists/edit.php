        ...
        <div class="pd-20 card-box mb-30">
          ...
          <form method="POST" action="<?php echo base_url(); ?>/editEventData" enctype="multipart/form-data" style="margin-top:30px;">
            ...
            <div class="form-group">
              ...
              <div class="form-line">
                <input type="datetime" class="form-control" name="date" placeholder="<?php echo $locale['event_date']; ?>" required="" value="<?php echo $event->date; ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="form-line">
                <input type="time" class="form-control" name="time" placeholder="<?php echo $locale['event_time']; ?>" required="" value="<?php echo $event->time; ?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="form-line">
                <input type="text" class="form-control" name="title" placeholder="<?php echo $locale['event_title']; ?>" required="" autofocus="" value="<?php echo $event->title; ?>">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" style="margin-top:30px;">
              <label><?php echo $locale['event_detail']; ?></label>
              <div class="form-line">
