  ...
  <div class="xs-pd-20-10 pd-ltr-20">
    <div class="page-header">
      <div>
        ...
        <nav class="lt-bc"><a href="<?= base_url() ?>">Dashboard</a><span>/</span><span><?= $locale['edit_details'] ?></span></nav>
      </div>
    </div>
    ...
    <form method="POST" action="<?= base_url('editEventData') ?>" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="nf-card">
            <div class="nf-card-head"><h3 class="nf-card-title">Poster</h3><p class="nf-card-sub">Click to change</p></div>
            <div class="nf-card-body" style="padding-top:8px;">
              <div class="nf-upload-zone" id="lst-poster-zone" onclick="document.getElementById('lst-poster-input').click()">
              ...
              <input type="file" id="lst-poster-input" name="thumbnail" accept="image/png,image/jpeg" style="display:none;" onchange="nfPreview(this,'lst-poster-zone')">
            </div>
          </div>
        </div>
      </div>
