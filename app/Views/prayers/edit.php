        ...
        <div class="row">
          <div class="col-md-6 col-sm-12">
            ...
            <nav aria-label="breadcrumb" role="navigation">
              <ol class="breadcrumb">
                <li class="breadcrumb-item active" aria-current="page"><?php echo $locale['edit_prayer']; ?></li>
              </ol>
            </nav>
          </div>
        ...
        <div class="pd-20 card-box mb-30">
          ...
          <form method="POST" action="<?php echo base_url(); ?>/editprayerdata" enctype="multipart/form-data" style="margin-top:30px;">
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <input type="text" class="form-control" name="requester" value="<?php echo $prayer->requester; ?>" placeholder="<?php echo $locale['requester']; ?>">
              </div>
            </div>
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <input type="text" class="form-control" name="title" value="<?php echo $prayer->title; ?>" placeholder="<?php echo $locale['request_title']; ?>" required="" autofocus="">
              </div>
            </div>
            ...
            <div class="box-footer text-center">
              <button class="btn btn-primary waves-effect" type="submit"><?php echo $locale['update_prayer']; ?></button>
            </div>
