        ...
        <div class="pd-20 card-box mb-30">
          ...
          <form id="upload-form">
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <input type="text" class="form-control" id="title" placeholder="<?php echo $locale['audio_title']; ?>" required="" autofocus="">
            </div>

            <div class="form-group">
              <label><?php echo $locale['audio_desc_ex']; ?></label>
              <div class="form-line">
                <textarea type="text" class="form-control" id="description" placeholder="<?php echo $locale['audio_desc']; ?>" autofocus=""></textarea>
              </div>
            </div>

            <div class="form-group" style="margin-top:20px;">
              <div class="form-line">
                <label><?php echo $locale['audio_type']; ?></label>
                <select class="form-control" id="audio_type" required="" autofocus="">
                  <option value="0" selected><?php echo $locale['upload_audio_file']; ?></option>
                  <option value="1"><?php echo $locale['provide_audio_link']; ?></option>
                </select>
              </div>
            </div>
            ...
            <div id="upload_div">
              <div class="form-group" style="margin-top:20px;">
                <label><?php echo $locale['media_cov']; ?></label>
                <div class="form-line">
                  <input id="thumbnail" type="file" data-allowed-file-extensions="jpeg jpg png JPEG PNG" class="dropify2">
                </div>
              </div>

              <div class="form-group" style="margin-top:20px;">
                <label><?php echo $locale['mp3_file']; ?></label>
                <div class="form-line">
            ...
            <div id="link_div" style="margin-top:20px; display:none;">
              ...
              <div class="form-group" style="margin-top:20px;">
                <label><?php echo $locale['audio_link']; ?></label>

                <div class="form-line">
                  <input type="url" class="form-control" id="media_link" placeholder="<?php echo $locale['audio_link']; ?>" autofocus="">
                </div>
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <input type="text" class="form-control" id="duration" name="duration" placeholder="<?php echo $locale['audio_duration']; ?>" required="" autofocus="">
              </div>
            </div>
            ...
            <div class="form-group" style="margin-top:20px;">
              ...
              <div class="form-line">
                <label><?php echo $locale['allow_vid_down']; ?> <br>
                  <small><?php echo $locale['download_availability']; ?></small></label>
            ...
            <div class="box-footer text-center" style="margin-top:20px;">
              <button id="submit" onclick="uploadNewAudio(event)" class="btn btn-primary waves-effect" type="submit"><?php echo $locale['new_audio_upload']; ?></button>
