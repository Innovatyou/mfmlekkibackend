...
try {
    ...
    foreach ($roles as $role) {
        ...
        $sql = "INSERT INTO tbl_roles (name, display_name, description, created_at, updated_at) 
    ...
    foreach ($permissions as $permission) {
        ...
        $sql = "INSERT INTO tbl_permissions (name, display_name, module, created_at, updated_at) 
                VALUES ('$name', '$displayName', '$module', '$now', '$now')";
        $mysqli->query($sql);
    }
    echo "✓ Inserted 24 permissions\n";
    ...
    foreach ($rolePermissions as $roleName => $permissionNames) {
        ...
        foreach ($permissionNames as $permissionName) {
            ...
            $now = date('Y-m-d H:i:s');
            $sql = "INSERT INTO tbl_role_permissions (role_id, permission_id, created_at) 
